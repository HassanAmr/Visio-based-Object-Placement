...
def download(search_keyword, keywords, destination_dir, download_limit, log_dir):
    ############## Main Program ############
    ...
    while i<len(search_keyword):
        ...
        info = open(log_dir+'/'+'download_images_log.txt', 'a')        #Open the text file called database.txt
...
#    download(['cheez-it', 'junk food'], [''], 'seach_results', 100)